...
export default function HomePage() {
  ...
  return (
    ...
    <div className="flex min-h-screen flex-col h-full w-screen flex-col items-center justify-center overflow-hidden">
      ...
      <h1 className="text-edge-outline z-10 animate-fade-in cursor-default bg-white bg-clip-text text-center text-3xl duration-1000 lg:animate-title lg:text-4xl lg:whitespace-nowrap">
        {t("page.home.title")}
      </h1>
      ...
      <div className="absolute inset-x-20 bottom-10 my-16 animate-fade-in text-center">
        <h2 className="text-sm text-zinc-100 hidden  text-center lg:block ">
